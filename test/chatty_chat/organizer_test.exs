defmodule ChattyChat.OrganizerTest do
  use ChattyChat.DataCase
  ...
  describe "rooms" do
    ...
    @valid_attrs %{id: "some id", title: "some title"}
    @update_attrs %{id: "some updated id", title: "some updated title"}
